...
import 'package:mate_vibes/feature/donation/button.dart';
...
class Diana extends StatefulWidget {
  @override
  State<Diana> createState() => _DianaState();
}

class _DianaState extends State<Diana> {
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    "Diana will use the money to purchase the programming course to product more content about web and mobile app design",
                    style: TextStyle(
                        fontFamily: 'Manrope', color: grey, fontSize: 22),
                  ),
                )
