...
import 'package:mate_vibes/feature/donation/people/daniel/daniel.dart';
import 'package:mate_vibes/feature/donation/people/diana/diana.dart';
import 'package:mate_vibes/feature/donation/people/marcella/marcella.dart';
import 'package:mate_vibes/feature/donation/people/mark/mark.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: ListTile(
                  ...
                  subtitle: Text(
                    "To purchase programming course",
                  ),
                  trailing: IconButton(
                    icon: Icon(
                      Icons.attach_money,
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Diana()));
                    },
                  )),
            ),
            Container(
              ...
              child: ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Daniel()));
                    },
                  )),
            ),
            Container(
              ...
              child: ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Marcella()));
                    },
                  )),
            ),
            Container(
