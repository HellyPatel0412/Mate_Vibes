    ...
    return ListView(
      children: [
        ...
        ListTile(
            ...
            trailing: Wrap(
              children: [Icon(Icons.star_border), Icon(Icons.share)],
            )),
        SizedBox(
          height: 20,
        ),
        ...
        Container(
            height: 200,
            child: Image.network(
                "https://organisemyhouse.com/wp-content/uploads/2020/11/QUOTE-21-life-one-time-offer.jpg")),
        ListTile(
            leading: Wrap(
              children: [
                Icon(
        ...
        Container(
          height: 200,
          child: Image.network(
              "https://images.unsplash.com/photo-1603107776328-0a2e5b7d08e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=436&q=80"),
        ),
        ListTile(
            leading: Wrap(
              children: [
